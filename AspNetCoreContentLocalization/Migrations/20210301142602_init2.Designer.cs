...
namespace AspNetCoreContentLocalization.Migrations
{
    ...
    [Migration("20210301142602_init2")]
    partial class init2
    {
            ...
            modelBuilder.Entity("AspNetCoreContentLocalization.Data.Entities.LocalizationSet", b =>
                {
                    b.HasOne("AspNetCoreContentLocalization.Data.Entities.Book", null)
                        .WithOne("Author")
                        .HasForeignKey("AspNetCoreContentLocalization.Data.Entities.LocalizationSet", "AuthorId");

                    b.HasOne("AspNetCoreContentLocalization.Data.Entities.Book", null)
                        .WithOne("Description")
                        .HasForeignKey("AspNetCoreContentLocalization.Data.Entities.LocalizationSet", "DescriptionId");

                    b.HasOne("AspNetCoreContentLocalization.Data.Entities.Book", null)
                        .WithOne("Name")
                        .HasForeignKey("AspNetCoreContentLocalization.Data.Entities.LocalizationSet", "NameId");
                });
